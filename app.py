...
PASTA_BASE_ENV = os.getenv("PASTA_BASE")

if not PASTA_BASE_ENV:
    raise ValueError(
        "A variável PASTA_BASE não foi encontrada. "
        "Configure-a no arquivo .env."
    )

PASTA_BASE = Path(PASTA_BASE_ENV)
...
PASTA_BASE_VECTORSTORE_ENV = os.getenv(
    "PASTA_BASE_VECTORSTORE"
)

if not PASTA_BASE_VECTORSTORE_ENV:
    raise ValueError(
        "A variável PASTA_BASE_VECTORSTORE não foi encontrada. "
        "Configure-a no arquivo .env."
    )

PASTA_BASE_VECTORSTORE = Path(
    PASTA_BASE_VECTORSTORE_ENV
)
